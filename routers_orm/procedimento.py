"""Procedimentos com ORM (Etapa 2). Espelha routers/procedimento.py.
...
from orm.modelos import Procedimento
...
router = APIRouter(prefix="/orm/procedimentos", tags=["ORM - Procedimentos"])
